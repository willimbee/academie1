...
<html lang="fr">
  <head>
    <title>Sedjif Languages and Translation Services</title>
    <meta charset="utf-8">
    ...
    <link rel="shortcut icon" type="x-icon" href="Logo_slts.ico">
  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.php">SLTS</a></div>
    ...
    <div class="intro-section" id="home-section">
      ...
      <div class="slide-1" style="background-image: url('images/Logo_slts.png');" data-stellar-background-ratio="0.5">
        <div class="container">
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/Logo_slts.png');">
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-md-8 text-center testimony">
            ...
            <blockquote>
              <p>&ldquo; I was struggling with my studies but it all changed when I learned about SLTS, I'm now a senior software engineer making a 6 figure salary per year.This website is a real game changer. &rdquo;</p>
            </blockquote>
          </div>
        </div>
      </div>
    ...
    <footer class="footer-section bg-white">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <h3>About SLTS</h3>
            <p>Sedjif Languages And translation Services offer:  
            <ul class="list-unstyled footer-links">
              <li>Certified Translation services/training in professional English</li>
              <li>TOEFL/IELTS/ TOEIC/ ACT/ BULATS....</li>
              <li>PRIVATE COURSES/ FRENCH CLASSES/ online classes with flexible hours</li>
              <li></li>
            </ul>
            </p>
          </div>
          ...
          <div class="col-md-4">
            <h3>Subscribe</h3>
            <p>Keep yourself up to date and receive all kind of news about SLTS.</p>
        ...
        Tioka Technologie -- Copyright &copy;<script>document.write(new Date().getFullYear());</script> -- All rights reserved
        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
      </p>
            </div>
          </div>
